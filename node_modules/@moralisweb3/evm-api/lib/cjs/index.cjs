    ...
    function ClientEvmApi() {
        ...
        _this.nft = {
            ...
            getNFTTradesByToken: function (request) {
                return new apiUtils.PaginatedOperationV3Resolver(commonEvmUtils.GetNFTTradesByTokenOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getNFTContractSalePrices: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetNFTContractSalePricesOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getNFTSalePrices: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetNFTSalePricesOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        ...
        _this.token = {
            ...
            getTokenOwners: function (request) {
                return new apiUtils.PaginatedOperationV3Resolver(commonEvmUtils.GetTokenOwnersOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            ...
            getTopProfitableWalletPerToken: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetTopProfitableWalletPerTokenOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        };
        _this.resolve = {
        ...
        _this.wallets = {
            getWalletHistory: function (request) {
                return new apiUtils.PaginatedOperationV3Resolver(commonEvmUtils.GetWalletHistoryOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            ...
            getDefiSummary: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetDefiSummaryOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getDefiPositionsByProtocol: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetDefiPositionsByProtocolOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getDefiPositionsSummary: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetDefiPositionsSummaryOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            ...
            getWalletProfitabilitySummary: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetWalletProfitabilitySummaryOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getWalletProfitability: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetWalletProfitabilityOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        };
        _this.marketData = {
